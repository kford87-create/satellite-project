...
class SupabaseStorageManager:
    ...
    def save_fn_report(self, report: Dict):
        ...
        try:
            # Omit created_at — the column has DEFAULT NOW() so the DB sets it
...
-- Auto-update updated_at on dataset_images whenever a row is modified
-- (Matches the same pattern used in add_api_tables.sql for api_clients)
...
CREATE OR REPLACE TRIGGER trg_dataset_images_updated_at
    BEFORE UPDATE ON dataset_images
